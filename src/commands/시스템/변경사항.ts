...
export default {
  data: new SlashCommandBuilder()
    .setName("변경사항")
    .setDescription("Justy의 최근 변경사항을 불러옵니다."),

  async execute(interaction: ChatInputCommandInteraction) {
    let githubReleasesData: any = await axios.get("https://github.com/GService0/Justy/releases");
    ...
    let githubCommitData: any = await axios.get("https://github.com/GService0/Justy/commit/main");
    ...
    const embed = new EmbedBuilder()
      ...
      .setURL("https://github.com/GService0/Justy")
      .addFields(
